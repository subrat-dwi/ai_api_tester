    ...
    >
      ...
      <div className="relative flex flex-col gap-5 rounded-lg border border-sky-300/15 bg-slate-950/70 p-4">
        <div>
          ...
          <div className="mt-4 rounded-md border border-sky-400/25 bg-sky-500/10 px-4 py-3 font-mono text-sm text-sky-100 shadow-glowBlue">
            {endpoint}
          </div>
        </div>

        <div className="space-y-4">
          <div className="rounded-md border border-slate-700/70 bg-slate-900/80 p-4">
